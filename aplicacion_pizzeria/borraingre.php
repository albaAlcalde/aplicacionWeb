...
if(!isset($_SESSION['usuario'])) 
{
  ...
  exit();
   ...
   if (isset($_REQUEST['borrar'])) {
		...
		$sSQL="Delete From ingredientes Where nombreIng='$nombre'";
		mysql_query($sSQL);
		mysql_close($conex);
?>
     <div class="container well" id="formatear">
       <img src="logo.jpg" alt="Avatar" height="256" width="256" class="img-responsive" id="logo">
<h1>Ingrediente eliminado</h1>
<a href='borraingre.php'>Eliminar otro ingrediente</a><br>	
...
?>
     <div class="container well" id="formatear">
       <img src="logo.jpg" alt="Avatar" height="256" width="256" class="img-responsive" id="logo">
<h1>Baja de ingredientes</h1><br>
<?php

echo '<form class="borde" method="post" action="borraingre.php">';
...
<br><br>
<input type="submit" name="borrar" value="Eliminar ingrediente" id="ingredientes"><br><br>
<a href="veringre.php">Volver</a>
</form>
<?php
	mysql_close($con);
