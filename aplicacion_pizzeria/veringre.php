...
<h1><div align="center">INGREDIENTES</div></h1>
<br>
<br>
<?php
//creamos la sesion
...
$consulta=mysql_query("select * from ingredientes");
...
$result=mysql_query("SELECT * FROM ingredientes ORDER BY nombreIng ASC LIMIT ".$inicio."," . $tam_pag);
//Mostramos los registros
while ($row=mysql_fetch_array($result))
{
echo '<tr><td>'.utf8_encode($row["nombreIng"]).'</td>';
echo '<td>'.utf8_encode($row["descripcion"]).'</td>';
if ($row["imagen"]== "")
	echo '<td>'.utf8_encode($row["imagen"]).'</td></tr>';
else
	echo "<td><a target='_blank' href='img/".$row["imagen"]."'><img src='img/ico.png'></a></td></tr>";
}
echo '</table>';
...
<a href="engadeingre.php">Añadir un nuevo ingrediente</a><br>
<a href="borraingre.php">Borrar un ingrediente</a><br>
