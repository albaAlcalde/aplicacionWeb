...
<h1><div align="center">MASAS</div></h1>
<br>
<?php
//creamos la sesion
session_start();
...
$consulta=mysql_query("select * from masas");
...
$result=mysql_query("SELECT * FROM masas ORDER BY idMasa ASC LIMIT ".$inicio."," . $tam_pag);

//Mostramos los registros
while ($row=mysql_fetch_array($result))
{
echo '<tr><td>'.utf8_encode($row["descripcion"]).'</td>';
...
<a href="addmasa.php">Añadir una nueva masa</a><br>
<a href="borramasa.php">Borrar una masa</a><br>
